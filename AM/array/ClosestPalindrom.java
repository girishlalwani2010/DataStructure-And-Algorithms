 ...
 *
 *12342 odd case -- 123 palindrom root , possible palindroms 12321,12421,12221 i.e. palindrom root equal to, plus 1, minus 1
 *1242 even case -- 12 palindrom root , possible palindroms 1221,1331,1111 i.e. palindrom root equal to, plus 1, minus 1
 *
 *
 */
public class ClosestPalindrom {
	...
	public String nearestPalindromic(String n) {
        ...
        //for even n.substring(0, len / 2), for odd n.substring(0, len / 2 + 1)
    ...
    private long toPalindromeDigits(String num, boolean isEvenDigits) {
        ...
        //for even num + reversedNum.toString()
        // for odd for ex: 12421 num"124" + (reversedNum.deleteCharAt(0))"21".toString();
