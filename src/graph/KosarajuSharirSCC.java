...
//Need to take topological order of reverse di-graph, and run DFS in original di-graph, using that topological order. 
// OR we can take topological order of  di-graph, and run DFS in reverse di-graph, using that topological order. 
// So Formula is Topological order of G(R) or G using DFS, then DFS/BFS on G or G(R)
