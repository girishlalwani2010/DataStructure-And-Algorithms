...
public class RearrangeAdjacentDuplicates{
	public static String rearrangeAdjacentDuplicates(String str){
		final class CharFreq implements Comparable<CharFreq>{
			...
			public int compareTo(CharFreq o) {
				int comp = Integer.compare(o.freq,freq);
				if(comp == 0){
		...
		PriorityQueue<CharFreq> maxHeap = new PriorityQueue<CharFreq>(256);
	...
	public static void main(String[] args) {
		...
		System.out.println(rearrangeAdjacentDuplicates.rearrangeAdjacentDuplicates("aaabc"));
	}
